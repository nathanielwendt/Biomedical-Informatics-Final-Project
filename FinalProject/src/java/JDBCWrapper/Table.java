...
public class Table
{
  ...
  private RowSet execute( String criteria ) throws SQLException {
	 ...
	 */
  private RowSet execute( String criteria, Vector colNames) throws SQLException {
    Connection con = database.getConnection();
    Statement st = con.createStatement();
    ...
    for(int i=0; i<colNames.size();i++) {
    	...
    	query = query + " [" + (String)colNames.elementAt(i) + "]";
    }
  ...
  public RowSet getRows( String criteria, Vector colNames) throws SQLException {
